<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
  <mask id="moonMask">
    ...
    <circle class="fill-black origin-top-right scale-100 dark:scale-0" cx="34" cy="14" r="16" />
  </mask>

  <g mask="url(#moonMask)">
    <circle class="fill-current scale-125 dark:scale-50" cx="25" cy="25" r="16" />

    <g class="fill-none stroke-current stroke-round stroke-[5px] scale-0 dark:scale-100">
